...
System.register(["angular2/platform/browser", "angular2/core", "./ts/services/Headquarter", "./ts/services/PathService", "./ts/services/BuildService", "./ts/services/DeleteService", "./ts/services/SplashService", "./ts/services/SelectService", "./ts/services/CopyService", "./ts/services/MoveService", "./ts/services/CopyAndRotateService", "./ts/classes/Parser", "./ts/classes/ProgressiveLoader", "./ts/classes/Renderer", "./ts/components/MapComponent", "./ts/components/BuildMenu", "./ts/components/Line", "./ts/components/ServiceLoader", "./ts/components/ContextMenu", "./ts/components/SaveMenu", "./ts/components/TemplatesMenu", "./ts/components/AlertsComponent"], function(exports_1, context_1) {
    "use strict";
    ...
    var browser_1, core_1, Headquarter_1, PathService_1, BuildService_1, DeleteService_1, SplashService_1, SelectService_1, CopyService_1, MoveService_1, CopyAndRotateService_1, Parser_1, ProgressiveLoader_1, Renderer_1, MapComponent_1, BuildMenu_1, Line_1, Line_2, ServiceLoader_1, ContextMenu_1, SaveMenu_1, TemplatesMenu_1, TemplatesMenu_2, AlertsComponent_1;
    var mainApp;
    return {
        setters:[
            ...
            mainApp = (function () {
                ...
                mainApp = __decorate([
                    core_1.Component({
                        ...
                        directives: [MapComponent_1.MapComponent, Line_2.LineComponent, BuildMenu_1.BuildMenuComponent, ServiceLoader_1.ServiceLoader, ContextMenu_1.ContextMenuHolder, SaveMenu_1.SaveMenuHolder, TemplatesMenu_1.TemplatesMenu, AlertsComponent_1.AlertsComponent],
