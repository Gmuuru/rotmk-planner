    ...
    return {
        ...
        execute: function() {
            Cell = (function () {
                ...
                Cell.prototype.getBuildingName = function () {
                    if (this.ref) {
                        return null;
                    }
                    else {
                ...
                Cell.prototype.getBuildingWidth = function () {
                    if (this.ref) {
                        return null;
                    }
                    else {
                ...
                Cell.prototype.getBuildingHeight = function () {
                    if (this.ref) {
                        return null;
                    }
                    else {
                ...
                Cell.prototype.highlight = function (hl, orientation) {
                    this.hl = hl;
                ...
                Cell.getBuildingData = function (char) {
            ...
            exports_1("Cell", Cell);
            Building = (function () {
                function Building(char, name, width, height, label, labelMenu, renderingService) {
                    this.char = char;
                    this.name = name;
                    this.width = width;
                    this.height = height;
                ...
                Building.clone = function (building) {
                    return new Building(building.char, building.name, building.width, building.height, building.label, building.labelMenu, building.renderingService);
                };
                Building.getDefaultBuilding = function () {
