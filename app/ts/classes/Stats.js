        ...
        execute: function() {
            Stats = (function () {
                function Stats() {
                    ...
                    this.houses = ['Shelter', 'Hut', 'Plain Cottage', 'Attractive Cottage',
                        'Spacious Dwelling', 'Elegant Dwelling', 'Ornate Apartment', 'Luxury Apartment'];
                    this.elites = ["Modest Siheyuan", "Lavish Siheyuan", "Humble Compound", "Impressive Compound", "Heavenly Compound"];
                    this.difficulties = ["Very Easy", "Easy", "Normal", "Hard", "Very Hard"];
                    this.taxAndWageRates = ["Very Low", "Low", "Normal", "High", "Very High"];
                    this.houseData = {
                        "Shelter": { trm: 0, pop: 7 },
                        "Hut": { trm: 0, pop: 14 },
                ...
                Stats.prototype.getDifficulty = function () {
                    return this.difficulty;
                };
                Stats.prototype.setDifficulty = function (val) {
                    this.difficulty = val;
                };
                Stats.prototype.getTaxRate = function () {
                    return this.taxRate;
                };
                Stats.prototype.setTaxRate = function (val) {
                    this.taxRate = val;
                };
                Stats.prototype.getWageRate = function () {
                    return this.wageRate;
                };
                Stats.prototype.setWageRate = function (val) {
                    this.wageRate = val;
                };
                Stats.prototype.computeData = function (house, quantity) {
                ...
                Stats.prototype.computeWorkers = function (house, pop) {
                    if (this.houseData[house].trm >= 10) {
                        return 0;
                    }
                    var percent = this.wageRates[this.difficulty][this.wageRate].workers;
                    return Math.floor(pop * percent);
                };
                Stats.prototype.computeTaxes = function (house, pop) {
                    var trm = this.houseData[house].trm;
                    return Math.round(pop * trm * (this.taxRate + 1) * 0.03) * 12;
                };
                Stats.prototype.computeWages = function (house, workers) {
                    var wages = this.wageRates[this.difficulty][this.wageRate].wages;
                    return Math.floor(workers * wages);
                };
                Stats.prototype.computeFood = function (house, pop) {
                    var trm = this.houseData[house].trm;
                    if (trm == 0 || trm == 10) {
                        return 0;
                    }
                ...
                Stats.prototype.computeHemp = function (house, pop) {
                    var trm = this.houseData[house].trm;
                    if (pop <= 22 && trm <= 1) {
                        return 0;
                    }
                ...
                Stats.prototype.computeCeram = function (house, pop) {
                    var trm = this.houseData[house].trm;
                    if (pop <= 41 && trm <= 1) {
                        return 0;
                    }
                ...
                Stats.prototype.computeSilk = function (house) {
                    var trm = this.houseData[house].trm;
                    if (trm <= 10) {
                        return 0;
                    }
                ...
                Stats.prototype.computeWares = function (house) {
                    var trm = this.houseData[house].trm;
                    if (trm <= 18) {
                        return 0;
                    }
                ...
                Stats.prototype.computeTea = function (house, pop) {
                    var trm = this.houseData[house].trm;
                    if (trm != 2 && trm != 24) {
                        return 0;
                    }
                ...
                Stats.getBuildingData = function (char) {
